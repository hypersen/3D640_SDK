...
enum
{
	ONI_DEVICE_PROPERTY_FIRMWARE_VERSION		= 0, //HPSFirmwarVersion
	...
	//hypersen
	HPS_DEVICE_PROPERTY_CAM_PARAMS			= 21, // HPSCameraParams
	HPS_DEVICE_PROPERTY_SMOOTH_FILTER		= 22, // HPSSmoothFilter
	HPS_DEVICE_PROPERTY_KALMAN_FILTER		= 23, // HPSKalmanFilter
	HPS_DEVICE_PROPERTY_EDGE_FILTER			= 24, // HPSEdgeFilter
	HPS_DEVICE_PROPERTY_WATCH_DOG			= 25, // OniBool
...
enum
{
	...
	//hypersen
	HPS_STREAM_PROPERTY_DEPTH_OFFSET = 11, // int
