...
enum
{
	DEVICE_PROPERTY_FIRMWARE_VERSION		= 0, // HPSFirmwarVersion
	...
	//hypersen
	DEVICE_PROPERTY_CAM_PARAMS = 21, // HPSCameraParams
	DEVICE_PROPERTY_SMOOTH_FILTER = 22, // HPSSmoothFilter
	DEVICE_PROPERTY_KALMAN_FILTER = 23, // HPSKalmanFilter
	DEVICE_PROPERTY_EDGE_FILTER = 24, // HPSEdgeFilter
	DEVICE_PROPERTY_WATCH_DOG = 25, // OniBool
...
enum
{
	...
	//hypersen
	STREAM_PROPERTY_DEPTH_OFFSET = 11, // int
